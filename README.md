...
#### 使用说明  
1.安装[官方ss客户端](https://github.com/snail007/goproxy-ss-plugin-android/releases)。  
2.安装 ss-goproxy 插件， [点击下载](https://github.com/snail007/goproxy-ss-plugin-android/releases)。  
